...
/** @type {string} */
const CACHE_VERSION = '1726952914|22790627938';
/** @type {string} */
const CACHE_PREFIX = 'CashewClicker-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'CashewClicker.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["CashewClicker.html","CashewClicker.js","CashewClicker.offline.html","CashewClicker.icon.png","CashewClicker.apple-touch-icon.png","CashewClicker.worker.js","CashewClicker.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["CashewClicker.wasm","CashewClicker.pck"];
